...
- Montar un contedor con unshare, limitando os [namespaces](https://gustavoesteban.github.io/formacion/docker/#/01_que_e_un_contedor_de_software/08_namespaces_en_profundidade), facer un chroot a onde está o sistema de ficheiros descargado...
- ...
